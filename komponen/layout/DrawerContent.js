  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={Actions.closeDrawer}>Back</TouchableOpacity> */}
        <Text>Title: {this.props.title}</Text>
        {this.props.name === 'tab_1_1' && <TouchableOpacity onPress={Actions.tab_1_2}>
          <Text>next screen for tab1_1</Text>
        </TouchableOpacity>}
        {this.props.name === 'tab_2_1' && <TouchableOpacity onPress={Actions.tab_2_2}>
